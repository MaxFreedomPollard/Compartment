...
allowed-tools: mcp__compartment__memory_search, mcp__compartment__memory_store, mcp__compartment__memory_store_many, mcp__compartment__memory_status, mcp__compartment__memory_recent
metadata:
  hermes:
